        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
           <div className="md:w-1/2 flex justify-center relative">
            <div className="relative">
              ...
              <div className="absolute inset-0 w-80 h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-primary to-secondary -z-10 opacity-30 blur-xl animate-pulse"></div>
            </div>
          </div>

          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold mb-5 font-poppins">
            ...
            <p className="text-xl text-text-light mb-8 mx-auto md:mx-0 max-w-[90%]">
